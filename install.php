...
<html>
	<head>
		<title>ABXD ESR installation</title>
			...
			<tr class="cell0">
				<td style="max-height: 500px; height: 500px; vertical-align: top;" id="installPager">
					<div class="page" id="page1">
						<h3>Welcome to ABXD ESR!</h3>
						<p>
							Welcome to the installer for ABXD.
							We've done a few changes in 3.2 to make using ABXD even better, including:
							<ul>
						...
						<p>
							...
							- The ABXD developers & ESR developers
					</div>
